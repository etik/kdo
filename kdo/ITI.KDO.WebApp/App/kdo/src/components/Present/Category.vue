...
<div>
    ...
    <b-row >
       ...
       <img :src="'i.img'">
        ...
        <div class="feature-box event" style="background-image: url(http://www.languagetop.com/wp-content/uploads/2017/10/why_you_should_only_play_games_on_your_computer.png);">
        <div class="CatDiv">
        <b-link href="presents/create" style="color: white;">{{categoryPresentList[0].categoryName}}</b-link>
        </div>
        ...
        <div class="CatDiv">
        <b-link href="presents/create" style="color: white;">{{categoryPresentList[1].categoryName}}</b-link>
        </div>
        </div>
        ...
        <div class="CatDiv">
        <b-link href="presents/create" style="color: white;">{{categoryPresentList[2].categoryName}}</b-link>
        </div>
        </div>  
        ...
        <div class="CatDiv">
        <b-link href="presents/create" style="color: white;">{{categoryPresentList[3].categoryName}}</b-link>
        </div>
        </div>
        </b-col>
        <b-col md="5">
        ...
        <div class="CatDiv">
        <b-link href="presents/create" style="color: white;">{{categoryPresentList[4].categoryName}}</b-link>
        ...
        <div class="CatDiv">
        <b-link href="presents/create" style="color: white;">{{categoryPresentList[5].categoryName}}</b-link>
        </div>
       </div>
        ...
        <div class="CatDiv">
        <b-link href="presents/create" style="color: white;">{{categoryPresentList[6].categoryName}}</b-link>
        </div>
        </div>
        </b-col>
        </b-col>
 ...
 import { mapActions } from 'vuex';
  ...
  export default {
    ...
    async mounted() {
        ...
        /*this.categoryPresentList[0].img = "../img/logoKdo.png";
        this.categoryPresentList[1].img = "http://www.languagetop.com/wp-content/uploads/2017/10/why_you_should_only_play_games_on_your_computer.png";
        this.categoryPresentList[2].img = "http://www.languagetop.com/wp-content/uploads/2017/10/why_you_should_only_play_games_on_your_computer.png";
        this.categoryPresentList[3].img = "http://www.languagetop.com/wp-content/uploads/2017/10/why_you_should_only_play_games_on_your_computer.png";
        this.categoryPresentList[4].img = "http://www.languagetop.com/wp-content/uploads/2017/10/why_you_should_only_play_games_on_your_computer.png";
        this.categoryPresentList[5].img = "http://www.languagetop.com/wp-content/uploads/2017/10/why_you_should_only_play_games_on_your_computer.png";
        this.categoryPresentList[6].img = "http://www.languagetop.com/wp-content/uploads/2017/10/why_you_should_only_play_games_on_your_computer.png";
    */
    },
